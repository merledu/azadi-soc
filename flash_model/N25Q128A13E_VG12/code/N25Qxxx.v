...
parameter [40*8:1] memory_file = "mem_Q128_bottom.vmf";

parameter [48*8:1] fdp_file = "sfdp.vmf";
...
module Memory(mem_file);
    ...
    initial begin 
        ...
        if ( mem_file!="" && mem_file!=" ") begin
          $readmemh("mem_Q128_bottom.vmf", memory);
