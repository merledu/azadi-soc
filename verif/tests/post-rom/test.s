...
_start:
  ...
  sw t0, 0x1c(a0) # led alive - GPIO 0 out en
  sw t0, 0x10(a0) # led alive - GPIO 0 out
  sw x0, 0x1c(a0) # led alive - GPIO 0 out en
...
clean:
  sw t0, 0x1c(a0) # led alive - GPIO 0 out en
  sw x0, 0x10(a0) # led alive - GPIO 0 out
  sw x0, 0x1c(a0) # led alive - GPIO 0 out en
  li t0, 0
  li t1, 0
  li t2, 0
